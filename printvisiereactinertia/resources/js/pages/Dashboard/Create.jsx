                            ...
                            <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="flex items-center mt-4">
                                            <label className="flex items-center">
                                                <input
                                                    ...
                                                    className="text-gray-600 bg-white border-gray-300 rounded shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                                                />
                                ...
                                <div className="flex items-center justify-end">
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="px-4 py-2 ml-4 font-bold text-white bg-blue-700 rounded hover:bg-blue-600 disabled:opacity-50 transition-colors duration-200"
                                    >
                                        Create Page
                                    </button>
                                </div>
