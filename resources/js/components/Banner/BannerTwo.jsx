                    ...
                    <div className="col-xl-6 col-lg-7">
                        <div className="banner-content-two">
                            <span className="sub-title">
                                Hi, I am John William
                            </span>
                            <h2 className="title">
                                Professional Product <span>Designer</span> Based
                                in USA
                            </h2>
                            <div className="banner-content-bottom">
                                ...
                                <ul className="list-wrap">
                                    <li>
                                        <a href="#">
                                            <img
                                                src="/img/icon/banner_icon01.svg"
                                                alt=""
                                            />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img
                                                src="/img/icon/banner_icon02.svg"
                                                alt=""
                                            />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img
                                                src="/img/icon/banner_icon03.svg"
                                                alt=""
                                            />
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img
                                                src="/img/icon/banner_icon04.svg"
                                                alt=""
                                            />
                                        </a>
                                    </li>
