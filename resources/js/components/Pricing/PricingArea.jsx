                    ...
                    <div className="col-lg-10">
                        <div className="section-title title-style-two text-center white-title mb-50">
                            ...
                            <p>
                                ...
                                adipisicing sed do eiusmod tempor incididunt
                                labore
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="row g-0 align-items-center justify-content-center">
                                <div className="col-lg-4 col-md-6">
                                    <div className="pricing-item">
                                        <div className="pricing-icon">
                                            <img
                                                src="/img/icon/pricing_icon01.png"
                                                alt=""
                                            />
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="pricing-item active">
                                        <div className="pricing-icon">
                                            <img
                                                src="/img/icon/pricing_icon02.png"
                                                alt=""
                                            />
                                        </div>
                                        <div className="pricing-top">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="pricing-item">
                                        <div className="pricing-icon">
                                            <img
                                                src="/img/icon/pricing_icon03.png"
                                                alt=""
                                            />
                                        </div>
                                        <div className="pricing-top">
